...
OVR="${DRUID_OVERRIDES:-/opt/druid/overrides/*}"
exec bin/run-java ${JAVA_OPTS} -cp "$OVR:$COMMON_CONF_DIR:$SERVICE_CONF_DIR:lib/*:$DRUID_ADDITIONAL_CLASSPATH" org.apache.druid.cli.Main server "$@"
